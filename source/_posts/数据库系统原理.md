...
- 当对表进行增删改查操作时，会对表上MDL读锁，允许其他线程增删改查，但不允许线程对表结构进行改变。

- 当对表结构进行改变时，会对表上MDL写锁，不允许其他线程的任何操作。

  https://blog.csdn.net/weixin_43767015/article/details/119836023
...
事务都是快照读，在可重复读级别下可以解决幻读问题

![img](https://img-blog.csdnimg.cn/20200801173201667.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM1NTkwMDkx,size_16,color_FFFFFF,t_70)
